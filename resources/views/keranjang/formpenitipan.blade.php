...
<a href="/"  style="margin-left:1280px; color:black"><i class="bi bi-arrow-left-square-fill" style="font-size:40px;"></i></a>
    ...
    <form action="/penitipan" method="post" style="background-color: white; padding: 20px;" enctype="multipart/form-data">
    @if(session('success'))
    ...
    @endif
        ...
        <table class="table mx-auto" style="background-color: white;">
            <tr>
                ...
                <td><input type="text" name="Nama_Hewan" class="form-control" placeholder="jenis-hewan / nama-hewan" required></td>
            </tr>
            <tr>
