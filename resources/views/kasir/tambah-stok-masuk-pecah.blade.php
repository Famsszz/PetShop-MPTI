...
@section('container')
    ...
    <div class="container" style="min-height: 100vh;">
        ...
        <div class="box">
            ...
            @endif
            <form action="/tambahstokpecahdb" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <label for="jumlah_pecah" style="text-align: left; display: block; margin-bottom: 5px;">Jumlah
                    Pecah:</label>
                <input type="number" name="jumlah_pecah" id="jumlah_pecah" class="input-control" placeholder="Jumlah Pecah"
                    required min="1">
