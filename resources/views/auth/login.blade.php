...
<body>
    ...
    <section class="ftco-section contact-section"
        style="background-image: url('{{ asset('images/kucingLog.png') }}'); background-size: contain; background-repeat: no-repeat; background-position: center center; height: 400px;">
        <div class="container">
            ...
            <div class="container" style="align-self: center; align-items: center;" x>
                ...
                <form action="{{ route('login') }}" class="bg-white p-5 contact-form"
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" placeholder="Email" name="email"
                            @error('email')  
                        @enderror id="email" autofocus required
                            value="{{ old('email') }}">
                        @error('email')
                ...
                <div class="col-md-4"
                    style="background-color: white; border-radius: 10px 10px 10px 10px;margin-top: -80px; margin-left:50px;">
                    <h5><a href="{{ route('password.request') }}">Forgot your password?</a></h5>
                </div>
                <div class="col-md-4"
                    style="background-color: white; border-radius: 10px 10px 10px 10px;margin-top: 20px; margin-left:50px;">
                    <h5><a href="{{ route('register') }}">Don't have an Email? Sign up now.</a></h5>
                </div>
            </div>
        </div>
    </section>
