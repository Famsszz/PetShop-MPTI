    ...
    <div class="container">
        <div class="container bg-white" style="align-self: center; align-items: center;">
            <div class="row no-gutters slider-text align-items-center justify-content-center">
                <div class="col-md-2 ftco-animate text-center" style="background-color: white; border-radius: 10px 10px 10px 10px;margin-top: 45px;">
            ...
            <h5 style="margin-top: -50px; margin-left:50px;"><a href="{{ route('login') }}">Already have an account? Sign In here</a></h5>
        </div>
    </div>
