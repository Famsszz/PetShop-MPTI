...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('barangjual', function (Blueprint $table) {
            $table->increments('ID_barangjual');
            ...
            $table->string('gambar'); 
            $table->enum('status', ['Keranjang_Barang', 'Menunggu_Pembayaran', 'Berhasil', 'Gagal', 'Offline', 'Selesai'])->default('Menunggu_Pembayaran')->nullable(false);
        });
    }
